...
const WBMetaDelete = () => {
  ...
  return (
    <Col md="12" className="wb-metaphysics-delete">
      <Formik
        ...
        onSubmit={(values, { setSubmitting }) => {
          ...
          formData.append("action", "deletemetaphysic");
      ...
      >
        ...
        <Form>
          ...
          <div className="form-group">
            {/*Submit Button*/}
            {submitButton("Delete Metaphysic")}
          </div>
        </Form>
      </Formik>
    </Col>
