...
const WBMetaCreate = () => {
  ...
  return (
    <Col md="12" className="wb-metaphysics-create">
      <Formik
        ...
        <Form>
          ...
          >
            ...
            <Tab eventKey="finish" title="Finish">
              <h4>Finish creating your metaphysic</h4>
              <p>You can always change it later!</p>
              {/*Submit Button*/}
              {submitButton("Create Metaphysic")}
            </Tab>
          </Tabs>
        </Form>
      </Formik>
