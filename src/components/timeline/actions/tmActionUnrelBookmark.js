...
const TMActionUnrelBookmark = () => {
  ...
  return (
    <Col md="12" className="tm-bookmarksinaction-delete">
      <Formik
        initialValues={formData}
        enableReinitialize
        validationSchema={Yup.object({})}
        onSubmit={(values, { setSubmitting }) => {
          formData.append("action", "unrelatebookmarktoaction");
      ...
      >
        {/*Action-Bookmark Unrelation Form*/}
        <Form>
          <div className="form-group">
            <h2>Delete Action-Bookmark Relation</h2>
            {/*Bookmark Id*/}
            {loadFormAttribute(
              "bookmark_id",
              "Bookmark",
...
export default TMActionUnrelBookmark;
